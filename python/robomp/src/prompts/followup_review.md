...
- Reply with a single `forge_post_comment` summarizing what changed — one line per concrete fix.
- Reviewer asking for clarification, not a change? Answer with `forge_post_comment` and NEVER touch the code.
